                ...
                <div class="col-12 col-lg-8 col-xl-9">
                    <div class="pr-lg-4 mb-100">
                        ...
                        <div class="post-details-content">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <img class="mb-30" src="assets/img/bg-img/51.jpg" alt="">
                                </div>
                                <div class="col-6">
                                    <img class="mb-30" src="assets/img/bg-img/52.jpg" alt="">
                                </div>
                            </div>
                        ...
                        <div class="post-author-area d-flex align-items-center my-5">
                            ...
                            <div class="author-avatar">
                                <img src="assets/img/bg-img/53.jpg" alt="">
                            </div>
                            <!-- Author Content -->
                        ...
                        <div class="pager-area d-flex align-items-center flex-wrap mb-80">
                            ...
                            <div class="pager-single-post d-flex align-items-center">
                                <div class="post-thumb">
                                    <a href="#"><img src="assets/img/bg-img/54.jpg" alt=""></a>
                                </div>
                                <div class="post-meta">
                            ...
                            <div class="pager-single-post d-flex align-items-center">
                                <div class="post-thumb">
                                    <a href="#"><img src="assets/img/bg-img/55.jpg" alt=""></a>
                                </div>
                                <div class="post-meta">
                    ...
                    <div class="confer-sidebar-area mb-100">
                        ...
                        <div class="single-widget-area">
                            ...
                            <div class="post-author-widget">
                                ...
                                <div class="post-author-avatar">
                                    <img src="assets/img/bg-img/50.jpg" alt="">
                                </div>
                                <!-- Author Content -->
                        ...
                        <div class="single-widget-area">
                            ...
                            <div class="single-recent-post-area d-flex align-items-center">
                                <!-- Thumb -->
                                <div class="post-thumb">
                                    <a href="single-blog.html"><img src="assets/img/bg-img/47.jpg" alt=""></a>
                                </div>
                                <!-- Content -->
                                <div class="post-content">
                                    <a href="single-blog" class="post-title">Los Angeles Institute</a>
                            ...
                            <div class="single-recent-post-area d-flex align-items-center">
                                <!-- Thumb -->
                                <div class="post-thumb">
                                    <a href="single-blog"><img src="assets/img/bg-img/48.jpg" alt=""></a>
                                </div>
                                <!-- Content -->
                                <div class="post-content">
                            ...
                            <div class="single-recent-post-area d-flex align-items-center">
                                <!-- Thumb -->
                                <div class="post-thumb">
                                    <a href="single-blog"><img src="assets/img/bg-img/49.jpg" alt=""></a>
                                </div>
                                <!-- Content -->
                                <div class="post-content">
                                    <a href="single-blog" class="post-title">Global Goals Mun</a>
                                    <a href="#" class="post-date"><i class="zmdi zmdi-time"></i> January 14, 2019</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-widget-area">
                            ...
                            <div class="sidebar-gallery">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <a href="#"><img src="assets/img/bg-img/25.jpg" alt=""></a>
                                    </div>
                                    <div class="col-4">
                                        <a href="#"><img src="assets/img/bg-img/26.jpg" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-60">
                            ...
                            <div class="footer-gallery">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="assets/img/bg-img/21.jpg" class="single-gallery-item"><img src="assets/img/bg-img/21.jpg" alt=""></a>
                                    </div>
                                    <div class="col-4">
                                        <a href="assets/img/bg-img/22.jpg" class="single-gallery-item"><img src="assets/img/bg-img/22.jpg" alt=""></a>
                                    </div>
                                    <div class="col-4">
                                        <a href="assets/img/bg-img/23.jpg" class="single-gallery-item"><img src="assets/img/bg-img/23.jpg" alt=""></a>
                                    </div>
                                    <div class="col-4">
                                        <a href="assets/img/bg-img/24.jpg" class="single-gallery-item"><img src="assets/img/bg-img/24.jpg" alt=""></a>
                                    </div>
                                    <div class="col-4">
                                        <a href="assets/img/bg-img/25.jpg" class="single-gallery-item"><img src="assets/img/bg-img/25.jpg" alt=""></a>
                                    </div>
                                    <div class="col-4">
                                        <a href="assets/img/bg-img/26.jpg" class="single-gallery-item"><img src="assets/img/bg-img/26.jpg" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
